...
<5> Click on attributes and add key avatar_url with value https://www.keycloak.org/resources/images/keycloak_logo_480x108.png. 
...
image::images/sso_jsconsoleuseravatar.png[User Consent]
...
image::images/sso_adminuserconsent.png[User Consent]
...
image::images/sso_useraccountrevoke.png[Revoking grants]

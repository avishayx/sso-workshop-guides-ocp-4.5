...
image::images/keycloak_create.png[Keycloak Template]
...
image::images/keycloak_httpurl.png[Keycloak url]
...
image::images/keycloak_quarkusapp.png[Keycloak Template]
...
image::images/keycloak_clientconfig.png[Keycloak Template]
...
image::images/keycloak_jsconsole.png[Keycloak Template]
